...
//Methods
  ...
  INT_PTR                                m_nDefaultMarkerIconIndex;
  MapPointerMode                         m_MapPointerMode;
  CMFCSensor<CMySensorEvents>            m_Sensor;
  ...
  afx_msg void OnProvidersOsmarender();
  afx_msg void OnUpdateProvidersOsmarender(CCmdUI* pCmdUI);
