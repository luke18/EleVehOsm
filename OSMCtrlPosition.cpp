...
COSMCtrlPosition::COSMCtrlPosition(double fLongitude, double fLatitude, double fBearing, double fSpeed, BOOL bBearingValid, BOOL bSpeedValid) : m_fLongitude(fLongitude),
